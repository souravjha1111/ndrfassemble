...
class FeedDataModel(models.Model):
    ...
    assemblelocationlatitude = models.CharField(max_length=100, blank=True)
    assemblelocationlongitude = models.CharField(max_length=100, blank=True)
    disisterlocationlatitude = models.CharField(max_length=100, blank=True)
    disisterlocationlongitude = models.CharField(max_length=100, blank=True)
